import { type Firestore, getDocs, query } from 'firebase/firestore';
...
import type { EventDocument, FirestoreDocument } from './types';
...
export function createEventSourcedRepository<T>(
  ...
  // Create a schema for T & { changes: Partial<T> }
